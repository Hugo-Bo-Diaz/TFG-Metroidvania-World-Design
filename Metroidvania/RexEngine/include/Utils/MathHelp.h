...
float DLL_EXPORT DistanceBetweenTwoPoints(float x1, float y1, float x2, float y2)
{
...
bool DLL_EXPORT LineIntersection(int Ax, int Ay, int Bx, int By, int Cx, int Cy, int Dx, int Dy, float& RetX, float& RetY)
{
